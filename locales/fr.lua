-- French locale strings for tmg-ambulancejob (death/wound/revive notifications, hospital menus, EMS text, body-part and pain labels).
local Translations = {
    error = {
        canceled = 'Annulé',
    ...
    info = {
        ...
        paleto_hospital = 'Hopital de Paleto',
